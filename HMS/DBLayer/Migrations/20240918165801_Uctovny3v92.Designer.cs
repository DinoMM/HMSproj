...
namespace DBLayer.Migrations
{
    ...
    [Migration("20240918165801_Uctovny3v92")]
    partial class Uctovny3v92
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBLayer.Models.UctovModels.UniConItemPoklDokladuConFlag", b =>
                {
                    b.Property<long>("UniConItemPoklDokladu")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DBLayer.Models.UctovModels.UniConItemPoklDokladuFlag", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DBLayer.Models.UctovModels.PolozkaSkladuConItemPoklDokladu", b =>
                {
                    b.HasBaseType("DBLayer.Models.UniConItemPoklDokladu");
                    ...
                    b.HasIndex("PolozkaSkladu")
                        .IsUnique()
                        .HasFilter("[PolozkaSkladu] IS NOT NULL");
            ...
            modelBuilder.Entity("DBLayer.Models.UctovModels.UniConItemPoklDokladuConFlag", b =>
                {
                    ...
                    b.HasOne("DBLayer.Models.UctovModels.UniConItemPoklDokladuFlag", "UniConItemPoklDokladuFlagX")
                        .WithMany()
